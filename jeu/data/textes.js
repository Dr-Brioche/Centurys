...
export const TEXTES = {
  ...
  "menu.aideSouris": { fr: "Tout se joue à la souris : clique les boutons du bas.",
                       en: "Everything is playable with the mouse: click the buttons at the bottom." },
  "menu.aideClavier":{ fr: "Clavier (facultatif) : 1 2 3 = troupes · 4 = revenu · 5 = défense · R = réparer · T = tourelle · E = évoluer · A = attaque spéciale · Retour arrière = annuler · P = pause · M = son",
                       en: "Keyboard (optional): 1 2 3 = troops · 4 = income · 5 = defence · R = repair · T = turret · E = evolve · A = special attack · Backspace = cancel · P = pause · M = sound" },
  ...
  "bouton.defense":  { fr: "Défense",          en: "Defence" },
  "bouton.reparer":  { fr: "Réparer",          en: "Repair" },
  ...
  "stat.pvMax":      { fr: "PV maximum",       en: "Maximum HP" },
  "stat.gainPv":     { fr: "+{n} PV",          en: "+{n} HP" },
  "stat.emplacementTourelle": { fr: "Débloque un emplacement de tourelle",
                                en: "Unlocks a turret slot" },
  ...
  "info.mursRenforces": { fr: "Remparts renforcés : +{n} PV et un emplacement de tourelle",
                          en: "Ramparts reinforced: +{n} HP and a turret slot" },
  "info.chateauIntact": { fr: "Le château n'a rien à réparer",
                          en: "The castle needs no repair" },
  "info.chateauRepare": { fr: "Château réparé : +{n} PV", en: "Castle repaired: +{n} HP" },
