...
import { demarrerPartie, majJeu, acheterUnite, ameliorerRevenu, evoluer, lancerSpecial,
         annulerDernier, acheterTourelle, ameliorerDefense, reparer } from './systems/combat.js';
...
function initClavier() {
  window.addEventListener('keydown', ev => {
    ...
    switch (k) {
      ...
      case '5': ameliorerDefense(j); break;
      case 'r': reparer(j); break;
